...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final Uint8List aesIv = Uint8List.fromList(<int>[0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01]);
  final Uint8List aesKey = Uint8List.fromList(<int>[0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01]);
  ...
  Uint8List encryptList(Uint8List data) {
    ...
    new ParametersWithIV<KeyParameter>(new KeyParameter(aesKey), aesIv);
